...
export const apiInstanse  = {. // PLEASE MOVE IT TO SEPARATE FILE "CONSTANTS"
...
export const setMovies = (payload, page) => ({ type: SET_MOVIES, payload,  page }) // SHOULD BE SINGLE OBJECT "PAYLOAD"
